    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <form class="col-md-12 p-t-10" role="form" method="POST" enctype="multipart/form-data" action="{{ route('buatkonten') }}">
          ...
          <div class="row">
            <div class="col">
            <label class="control-label" for="nomorRekening">Nomor Rekening</label>
            ...
            <input type="text" class="form-control{{ $errors->has('bank') ? ' is-invalid' : '' }}" name="bank" id="bank" value="{{ old('bank') }}">
            @if ($errors->has('bank'))
            <span class="invalid-feedback">
